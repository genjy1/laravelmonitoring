...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans">
        ...
        <div class="container w-4/5 mx-auto my-0 ">
            <h2 class="text-3xl pb-2 border-b mb-3.5 mt-3">Сервис <a href="{{route('common.home')}}" class="text-white border-r-2 bg-[#337ab7] rounded-[4px] border-[#2e6da4] text-lg mt-2 px-2 float-right">Привязать автомат</a></h2>
